...
public class MtgoxDepthFetchFragment extends Fragment {
  public static final String TAG = MtgoxDepthFetchFragment.class.getSimpleName();

  private static final String DEPTH_FETCH_SCHEME = "mtgox_category";
  private static final String DEPTH_FETCH_AUTHORITY = "depthfetch";
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
	  ...
	  final View v = inflater.inflate(R.layout.depth_fetch, container, false);
	  
	  mContext = (BaseActivity)getActivity();
	  
	  depth_webview = (WebView)v.findViewById(R.id.depth_webview);
  ...
  private void initWebView() {
		...
		depth_webview.loadUrl("http://i.btc123.com");
  }
