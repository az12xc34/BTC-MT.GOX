...
public class MtgoxWebFragment extends Fragment {
  public static final String TAG = MtgoxWebFragment.class.getSimpleName();

  private static final String MTGOX_SCHEME = "mtgox_category";
  private static final String MTGOX_AUTHORITY = "mtgox";
  public static final Uri MTGOX_URI = new Uri.Builder()
  .scheme(MTGOX_SCHEME)
  .authority(MTGOX_AUTHORITY)
  .build();
  ...
  public static final String PAGE_URL = "https://m.mtgox.com/";
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
	  ...
	  btcchina_webview.setOnLongClickListener(new WebView.OnLongClickListener() {
